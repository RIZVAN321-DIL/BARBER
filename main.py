...
async def help_cmd(message: Message):
    ...
    if user_id == ADMIN_ID:
        ...
        help_text = (
            "✂️ <b>Помощь</b>\n\n"
            "⚡ <b>Записаться</b> – выбрать услугу, дату, время (имя и телефон обязательны)\n"
            "📋 <b>Мои записи</b> – посмотреть и отменить активные записи (если до записи >2 часов)\n"
...
# ---------- ОБСЛУЖИВАНИЕ (нет) ----------
# У барбера нет отдельного обслуживания, поэтому только услуги
